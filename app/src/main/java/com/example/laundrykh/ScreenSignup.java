...
import com.example.laundrykh.model.SignUpResponse;
import com.example.laundrykh.remote.Api;
...
public class ScreenSignup extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(ScreenSignup.this);
